...
<!-- ============================== header ============================== -->
    <section class="contact-header">
      ...
      <p class="contact-header__lede">We're a small team working to keep this directory accurate and up to date. Whether you have a question about the site or need to update an attorney profile, we'd love to hear from you.</p>
    </section>
    ...
    <section class="reasons-wrap">
      <div class="reasons">
        <div class="reason">
          ...
          <p class="reason__body">Have a question about the directory or what a certification or professional recognition means? Send us a note. While we can't provide legal advice, we're happy to answer questions about the information you'll find on the site.</p>
        </div>
        ...
        <div class="reason">
          ...
          <p class="reason__body">If your profile needs to be updated, whether it's a new firm, contact information, office location, or professional recognition, let us know. Our goal is to keep every attorney profile as accurate and current as possible.</p>
        </div>
      </div>
    </section>
